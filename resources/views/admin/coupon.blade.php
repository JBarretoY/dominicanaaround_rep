...
@section('content')
    <div class="col s12">
        <div class="row">
            ...
            <input type="hidden" id="isAdmin" value="{{ Auth::user()->type }}">
            <div class="col s12">
                <div class="card">
                    <div class="card-content">
                        <div class="row">
                            <div class="col s12">
                                ...
                                <br>
                                <a class="waves-effect waves-light btn modal-trigger" id="modalcoupon" onclick="cleanFormCoupon()" href="#modal1">Nuevo Código</a>
                            </div>
                            <!--Modal-->
                            <!-- Modal Structure -->
                                        ...
                                        <div class="row">
                                            <form class="col s12">
                                                <div class="row">
                                                    ...
                                                    <div class="input-field col s12">
                                                        <input id="email_re" name="refers" type="text">
                                                        <label for="refers">Email</label>
                                                    </div>
