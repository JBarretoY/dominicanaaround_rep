...
Route::get('excursions', "SiteController@tours");
Route::get('/excursion/{id}', "SiteController@tour");
...
Route::post('paypal', 'PaymenPayPalController@payWithpaypal');
// route for check status of the payment
Route::get('status', 'PaymenPayPalController@getPaymentStatus');
...
Route::post('save-new','NewslettersController@createNewsletter');
Route::post('cash-hand','CashHand@makeCashHand');
