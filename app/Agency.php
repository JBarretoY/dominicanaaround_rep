 ...
 * @property string $lata_number
 * @property string $postal_code
 * @property string $host_agency_name
 * @property string $industry_market
 * @property string $address
 * @property string $comment
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Agency whereAddress($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Agency whereComment($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Agency whereHostAgencyName($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Agency whereIndustryMarket($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Agency whereLataNumber($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\Agency wherePostalCode($value)
 */
